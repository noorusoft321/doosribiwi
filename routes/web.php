...
//    $customerIds
//    $receiverIds = CustomerChatting::where('deleted',0)->groupBy('receiver_id')->pluck('receiver_id');
//    $senderIds = CustomerChatting::where('deleted',0)->groupBy('sender_id')->pluck('sender_id');
//    $chat = CustomerChatting::where('deleted',0)->groupBy('receiver_id')->groupBy('sender_id')->get();
//
//    dd($receiverIds,$senderIds,$chat);
//    $customerIds = Customer::where('email', 'LIKE', "%shaadi.org.pk%")->where('created_by','>',0)->pluck('id')->toArray();
...
//            'customerID'       => $customerId,
//            'messagelimits'    => 100,
//            'limit_start_date' => date('Y-m-d H:i:s'),
//            'limit_end_date'   => date('Y-m-d H:i:s',strtotime('+2 years'))
//        ]);
//    }
//    dd(count($customerIds));
//    $packages[0]['id'] = 3;
//    $packages[0]['color'] = '#b08d57';
//    $packages[0]['name'] = 'Bronze';
//
//    $packages[1]['id'] = 4;
//    $packages[1]['color'] = '#C0C0C0';
//    $packages[1]['name'] = 'Silver';
//
//    $packages[2]['id'] = 5;
//    $packages[2]['color'] = '#f0ca00';
//    $packages[2]['name'] = 'Gold';
//
//    $packages[3]['id'] = 6;
//    $packages[3]['color'] = '#64cbe2';
//    $packages[3]['name'] = 'Diamond';
//
//    $packages[4]['id'] = 7;
//    $packages[4]['color'] = '#747068';
//    $packages[4]['name'] = 'Platinum';
//
//    $customers = Customer::where('email', 'LIKE', "%shaadi.org.pk%")->whereNotIn('image',['default-female.jpg','default-male.jpg','default-user.png'])->where('deleted',0)->get();
//    foreach($customers as $val) {
//        $shuffleNumber = rand(0,4);
//        $val->update([
//            'package_id' => $packages[$shuffleNumber]['id'],
//            'user_package_color' => $packages[$shuffleNumber]['color'],
//            'user_package' => $packages[$shuffleNumber]['name']
//        ]);
//    }
//    dd(count($customers));
//    $customer = Customer::with('unreadMessageNumber')->where('name','SOPFF575')->first();
//    dd($customer);
//    $ids = [
//        "SOP-AH-1338",
//        "SOP-KF-1330",
...
//    $customers = Customer::whereIn('name',$ids)->update([
//        'status' => 1,
//        'profile_status' => 1,
//        'email_verified' => 1,
...
//    ]);
    dd('Doosri Biwi');
//    $allUserEmails = [];
//    $customers = Customer::with(['customerOtherInfo' => function($query) {
//        $query->whereIn('city_id',[551,1,591,748,592,748,592]);
