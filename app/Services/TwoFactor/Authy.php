...
class Authy {
    ...
    public function createApprovalRequest($authyId,$message,$options) {
        $response = $this->api->createApprovalRequest($authyId,$message,$options);

        return $response;
    }

    public function getApprovalRequest($uuId) {
