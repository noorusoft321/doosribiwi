...
<head>
    ...
    <title>Welcome | Doosri Biwi</title>
    <style type="text/css">
        body{
            width: 650px;
            ...
            <table style="width: 650px; margin: 0 auto; background-color: #fff; border-radius: 8px">
                ...
                <tr>
                    <td style="padding: 30px">
                        <h3 style="font-weight: 600">Account Verified</h3>
                        <h4 style="font-weight: 400;">Dear <strong>{{ $fullName }}</strong>,</h4>
                        <p style="margin-bottom: 0;">Your account has been successfully verified.</p>
                        <p>Click "Login" to access your account.</p>
                        <p><a target="_blank" href="{{Route('view.login')}}" style="padding: 10px; background-color: #0c476e; color: #fff; display: inline-block; border-radius: 4px">Login</a></p>
                        <br>
