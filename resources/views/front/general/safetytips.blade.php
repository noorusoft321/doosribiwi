...
@section('content')
	...
	<div class="container-xxl py-60">
		<div class="d-grid w-md-50 w-xl-80 mb-60 mx-auto gap-12">
			<h2 class="heading-section-3 text-dark text-center mb-0">Safety Tips</h2>
		...
		<div class="row w-xl-85 mx-auto">
			<div class="col-12 col-md-12 col-lg-12 my-12">
				<div class="card">
					<h5 class="card-header">Request for a Photo</h5>
					<div class="card-body">
						<p>
		...
		<div class="row w-xl-85 mx-auto">
			<div class="col-12 col-md-12 col-lg-12 my-12">
				<div class="card">
					<h5 class="card-header">Conversation Over Phone</h5>
					<div class="card-body">
						<p>
		...
		<div class="row w-xl-85 mx-auto">
			<div class="col-12 col-md-12 col-lg-12 my-12">
				<div class="card">
					<h5 class="card-header">Meet Only When You Are Ready</h5>
					<div class="card-body">
						<p>
		...
		<div class="row w-xl-85 mx-auto">
			<div class="col-12 col-md-12 col-lg-12 my-12">
				<div class="card">
					<h5 class="card-header">Choose A Safe Place To Meet</h5>
					<div class="card-body">
						<p>
		...
		<div class="row w-xl-85 mx-auto">
			<div class="col-12 col-md-12 col-lg-12 my-12">
				<div class="card">
					<h5 class="card-header">Look For Danger Signs</h5>
					<div class="card-body">
						<p>
						...
						<ul>
							<li>Hides or provides false information regarding interests, age, occupation, education, marital status etc.</li>
							<li>Have distinct appearance in person from pictures and profile</li>
							<li>Ignores to answer the direct questions</li>
							<li>Avoid introducing you to friends and family members</li>
						</ul>
					</div>
				</div>
				<!-- /.card-icon-component -->
		...
		<div class="row w-xl-85 mx-auto">
			<div class="col-12 col-md-12 col-lg-12 my-12">
				<div class="card">
					<h5 class="card-header">Beware of Scam Artists</h5>
					<div class="card-body">
						<p>
