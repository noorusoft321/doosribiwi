...
<main>
	<div class="container-xxl">
		<br>
        <h2 class="align-center font-weight-600"> Wedding Planning Services </h2>
		...
		<div class="row">
		    ...
		    <div class="col-md-3">
		        <div class="card about-height-hero">
		            <div class="card-body">
		                <img src="{{asset('customPages/normal/74561.png')}}" class="event-thumb" alt="">	
		            </div>
		        </div>
		        <!-- /.card-icon-component -->
		    </div>
