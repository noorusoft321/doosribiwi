...
@section('title','10 Tips That Will Help You Build a Good Relationship with Your In-laws')
@section('description', 'Marriage comes with big responsibilities that require you to develop courage and stamina to tackle with the challenging situations for a good relationship.')
...
@section('content')
	<div class="container-xxl py-60">
		<div class="card">
			<img src="{{asset('blogs-images')}}/Maintain-a-Good-Relationship-with-Your-In-Laws-300x225.jpg" alt="" class="full-width">
		...
		<div class="card">
			<img src="{{asset('blogs-images')}}/blog_slider_02.jpg" alt="" class="full-width">
			<h5 class="card-header">Prevent Any D-Day Disasters
			</h5>
			<div class="card-body">
				<div>
					<p>
		...
		<div class="card">
			<img src="{{asset('blogs-images')}}/blog_slider_02.jpg" alt="" class="full-width">
			<h5 class="card-header">Baby Soft Skin
			</h5>
			<div class="card-body">
				<div>
					<p>
		...
		<div class="card">
			<img src="{{asset('blogs-images')}}/blog_slider_02.jpg" alt="" class="full-width">
			<h5 class="card-header">Deciding On the Hair and Makeup
			</h5>
			<div class="card-body">
				<div>
					<p>
