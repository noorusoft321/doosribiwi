		...
		<div class="row">
			<div class="col-md-4">
				...
				<ul class="social-btn-group mt-34">
					...
					<li class="social-item">
						<a target="_blank" class="social-link" href="https://instagram.com/shaadipakistan?igshid=MzRlODBiNWFlZA==">
				...
				<div class="row">
					<div class="col-md-3">
						...
						<ul class="footer-link-list">
							<li class="link-item">
								<a class="link" href="{{route('social.connections')}}">Social Connections</a>
							</li>
							<li class="link-item">
								<a class="link" href="{{route('media.room')}}">Media Room</a>
							</li>
							<li class="link-item">
							...
							<li class="link-item">
								<a class="link" href="{{route('career')}}">Career</a>
							</li>
						</ul>
					</div>
					<!-- /.col -->
					<div class="col-md-3">
						...
						<ul class="footer-link-list">
							<li class="link-item">
								<a class="link" href="{{route('affiliate.program')}}">Affiliate Program</a>
							</li>
							<li class="link-item">
								<a class="link" href="{{route('advertise.with.us')}}">Advertise with us</a>
							</li>
							{{--<li class="link-item">
                                <a class="link" href="{{route('become.a.partner')}}">
                                    Start Your Matrimonial Matchmaking Business Become A Franchise Partner
                                </a>
                            </li>--}}
						</ul>
					</div>
					...
					<div class="col-md-3">
						...
						<ul class="footer-link-list">
							...
							<li class="link-item">
								<a class="link" href="{{route('terms.of.services')}}">Terms of Services</a>
							</li>
							<li class="link-item">
								<a class="link" href="{{route('picture.policy')}}">Picture Policy</a>
							</li>
							<li class="link-item">
								<a class="link" href="{{route('disclaimer')}}">Disclaimer</a>
							</li>
							<li class="link-item">
								<a class="link" href="{{route('report.misuse')}}">Report Misuse</a>
							</li>
							<li class="link-item">
					...
					<div class="col-md-3">
						...
						<ul class="footer-link-list">
							...
							<li class="link-item">
								<a class="link" href="tel:+922134830811"><i class="fa fa-volume-control-phone" aria-hidden="true"></i> Landline: +92-213-4830811</a>
							</li>
							<li class="link-item">
								<a class="link" href="tel:+922136644786"><i class="fa fa-volume-control-phone" aria-hidden="true"></i> Landline: +92-213-6644786</a>
							</li>
						</ul>
					</div>
					<!-- /.col -->
