    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.state.save')}}/' + mainId;
                $.get(`{{route('admin.state.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.state.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.state.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
