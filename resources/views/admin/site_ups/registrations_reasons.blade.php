    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.registrationsReason.save')}}/' + mainId;
                $.get(`{{route('admin.registrationsReason.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.registrationsReason.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.registrationsReason.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
