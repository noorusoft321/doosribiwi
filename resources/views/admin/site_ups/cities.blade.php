    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.city.save')}}/' + mainId;
                $.get(`{{route('admin.city.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.city.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.city.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
