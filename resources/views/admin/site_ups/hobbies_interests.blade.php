    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.hobbiesInterest.save')}}/' + mainId;
                $.get(`{{route('admin.hobbiesInterest.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.hobbiesInterest.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.hobbiesInterest.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
