    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.myLivingArrangement.save')}}/' + mainId;
                $.get(`{{route('admin.myLivingArrangement.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.myLivingArrangement.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.myLivingArrangement.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
