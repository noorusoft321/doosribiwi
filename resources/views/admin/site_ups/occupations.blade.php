    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.occupation.save')}}/' + mainId;
                $.get(`{{route('admin.occupation.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.occupation.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.occupation.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
