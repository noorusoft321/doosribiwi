    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.weight.save')}}/' + mainId;
                $.get(`{{route('admin.weight.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.weight.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.weight.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
