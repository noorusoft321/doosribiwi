    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.familyValue.save')}}/' + mainId;
                $.get(`{{route('admin.familyValue.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.familyValue.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.familyValue.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
