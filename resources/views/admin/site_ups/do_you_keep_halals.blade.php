    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.doYouKeepHalal.save')}}/' + mainId;
                $.get(`{{route('admin.doYouKeepHalal.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.doYouKeepHalal.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.doYouKeepHalal.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
