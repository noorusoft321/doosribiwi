    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.education.save')}}/' + mainId;
                $.get(`{{route('admin.education.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.education.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.education.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
