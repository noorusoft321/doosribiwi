    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.university.save')}}/' + mainId;
                $.get(`{{route('admin.university.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.university.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.university.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
