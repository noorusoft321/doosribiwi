    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.onBehalf.save')}}/' + mainId;
                $.get(`{{route('admin.onBehalf.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.onBehalf.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.onBehalf.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
