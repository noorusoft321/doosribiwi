    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.iAmLookingToMarry.save')}}/' + mainId;
                $.get(`{{route('admin.iAmLookingToMarry.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.iAmLookingToMarry.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.iAmLookingToMarry.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
