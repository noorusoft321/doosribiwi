    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.houseSize.save')}}/' + mainId;
                $.get(`{{route('admin.houseSize.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.houseSize.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.houseSize.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
