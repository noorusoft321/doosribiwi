    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.monthlyInCome.save')}}/' + mainId;
                $.get(`{{route('admin.monthlyInCome.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.monthlyInCome.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.monthlyInCome.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
