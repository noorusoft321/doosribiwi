    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.country.save')}}/' + mainId;
                $.get(`{{route('admin.country.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.country.save')}}';
                $(':input[name="name"]').val('');
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.country.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
