    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.religion.save')}}/' + mainId;
                $.get(`{{route('admin.religion.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.religion.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.religion.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
