    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.caste.save')}}/' + mainId;
                $.get(`{{route('admin.caste.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.caste.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.caste.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
