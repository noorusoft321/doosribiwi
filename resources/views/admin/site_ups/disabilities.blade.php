    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.disability.save')}}/' + mainId;
                $.get(`{{route('admin.disability.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.disability.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.disability.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
