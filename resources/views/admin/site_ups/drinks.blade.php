    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.drink.save')}}/' + mainId;
                $.get(`{{route('admin.drink.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.drink.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.drink.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
