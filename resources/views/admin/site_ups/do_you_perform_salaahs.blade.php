    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.doYouPerformSalaah.save')}}/' + mainId;
                $.get(`{{route('admin.doYouPerformSalaah.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.doYouPerformSalaah.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.doYouPerformSalaah.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
