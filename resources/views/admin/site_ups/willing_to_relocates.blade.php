    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.willingToRelocate.save')}}/' + mainId;
                $.get(`{{route('admin.willingToRelocate.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.willingToRelocate.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.willingToRelocate.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
