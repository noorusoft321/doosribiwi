    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.doYouHaveBeard.save')}}/' + mainId;
                $.get(`{{route('admin.doYouHaveBeard.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.doYouHaveBeard.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.doYouHaveBeard.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
