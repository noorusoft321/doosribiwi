    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.height.save')}}/' + mainId;
                $.get(`{{route('admin.height.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.height.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.height.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
