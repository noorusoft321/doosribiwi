    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.motherTongue.save')}}/' + mainId;
                $.get(`{{route('admin.motherTongue.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.motherTongue.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.motherTongue.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
