    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.whereDidYouHearAbout.save')}}/' + mainId;
                $.get(`{{route('admin.whereDidYouHearAbout.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.whereDidYouHearAbout.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.whereDidYouHearAbout.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
