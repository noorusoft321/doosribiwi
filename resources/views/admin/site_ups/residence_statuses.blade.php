    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.residenceStatus.save')}}/' + mainId;
                $.get(`{{route('admin.residenceStatus.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.residenceStatus.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.residenceStatus.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
