    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.sect.save')}}/' + mainId;
                $.get(`{{route('admin.sect.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.sect.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.sect.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
