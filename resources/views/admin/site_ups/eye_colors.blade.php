    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.eyeColor.save')}}/' + mainId;
                $.get(`{{route('admin.eyeColor.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.eyeColor.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.eyeColor.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
