    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.doYouPreferHijab.save')}}/' + mainId;
                $.get(`{{route('admin.doYouPreferHijab.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.doYouPreferHijab.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.doYouPreferHijab.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
