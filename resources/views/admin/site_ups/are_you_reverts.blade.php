    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.areYouRevert.save')}}/' + mainId;
                $.get(`{{route('admin.areYouRevert.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.areYouRevert.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.areYouRevert.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
