    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.hairColor.save')}}/' + mainId;
                $.get(`{{route('admin.hairColor.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.hairColor.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.hairColor.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
