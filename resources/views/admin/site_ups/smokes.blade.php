    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.smoke.save')}}/' + mainId;
                $.get(`{{route('admin.smoke.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.smoke.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.smoke.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
