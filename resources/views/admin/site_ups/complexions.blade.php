    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.complexion.save')}}/' + mainId;
                $.get(`{{route('admin.complexion.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.complexion.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.complexion.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
