    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.myBuild.save')}}/' + mainId;
                $.get(`{{route('admin.myBuild.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.myBuild.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.myBuild.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
