    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.residenceArea.save')}}/' + mainId;
                $.get(`{{route('admin.residenceArea.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.residenceArea.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.residenceArea.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
