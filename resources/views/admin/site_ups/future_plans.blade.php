    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.futurePlan.save')}}/' + mainId;
                $.get(`{{route('admin.futurePlan.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.futurePlan.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.futurePlan.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
