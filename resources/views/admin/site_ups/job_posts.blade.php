    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.jobPost.save')}}/' + mainId;
                $.get(`{{route('admin.jobPost.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.jobPost.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.jobPost.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
