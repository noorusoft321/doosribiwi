    ...
    <script>
        ...
        function addEditModal(input, mainId = '') {
            if (mainId) {
                ...
                createUpdateUrl = '{{route('admin.category.save')}}/' + mainId;
                $.get(`{{route('admin.category.detail')}}/${mainId}`, function (res) {
                ...
                createUpdateUrl = '{{route('admin.category.save')}}';
        ...
        function deleteRecord(input, mainId) {
            ...
            if (confirm("Are you sure you want to delete this?")) {
                $.get(`{{route('admin.category.delete')}}/${mainId}`, function (res) {
                    if (res.status == 'success') {
